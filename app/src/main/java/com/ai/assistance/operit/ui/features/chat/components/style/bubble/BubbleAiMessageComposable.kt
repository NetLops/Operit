...
fun BubbleAiMessageComposable(
        ...
        val showThinkingProcess by
                preferencesManager.showThinkingProcess.collectAsState(initial = true)
        ...
        // 收集显示偏好设置
        val showModelProvider by
                displayPreferencesManager.showModelProvider.collectAsState(initial = false)
                                        ...
                                        try {
                                                runBlocking {
                                                        ...
                                                        if (characterCard != null) {
                                                                preferencesManager
                                                                        .getAiAvatarForCharacterCardFlow(
                                                                                characterCard.id
                                                                        )
                                                        } else {
        ...
        val xmlRenderer =
                remember(showThinkingProcess, showStatusTags) {
                        CustomXmlRenderer(
                                showThinkingProcess = showThinkingProcess,
                                showStatusTags = showStatusTags
                        )
                }
        val rememberedOnLinkClick =
        ...
        val imageUrl =
                remember(message.content, message.contentStream) {
        ...
        Row(
                modifier =
                        Modifier.padding(horizontal = 0.dp, vertical = 4.dp)
                                .alpha(alpha)
                                .offset(y = offsetY.dp),
                ...
                Column(modifier = Modifier.padding(end = 32.dp).weight(1f, fill = false)) {
                                                ...
                                                key(message.timestamp) {
                                                        ...
                                                        if (stream != null) {
                                                                ...
                                                                StreamMarkdownRenderer(
                                                                        ...
                                                                        textColor = textColor,
                                                                        backgroundColor =
                                                                                Color.Transparent, // Transparent to let Box
                                                                        // background show
                                                                        onLinkClick =
                                                                                rememberedOnLinkClick,
